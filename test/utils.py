...
async def create_list_crud_object():
    ...
    return await SetBuilder().build(
        [
            ...
            EntityDescriptor(path=os.path.join("test", "descriptor", "entity13_bis.json"), export=True),
            EntityDescriptor(path=os.path.join("test", "descriptor", "entity13_ter.json"), export=True),
            EntityDescriptor(path=os.path.join("test", "descriptor", "entity13_quater.json"), export=True),
